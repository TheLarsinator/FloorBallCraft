...
public class BlockGoal3 extends Block implements ITileEntityProvider
{
	public static int rotangle = new Random().nextInt(3);

public BlockGoal3(int par1, Material wood)
{
    super(Material.wood);
...
public void registerBlockIcons(IIconRegister iconRegister)
{
    ...
    public void addCollisionBoxesToList(World par1World, int par2, int par3, int par4, AxisAlignedBB par5AxisAlignedBB, List par6List, Entity par7Entity)
    {
        ...
        this.setBlockBounds(0.9F, 0.0F, 0.0F, 1F, 1F, 1.0F);
        super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
        this.setBlockBoundsForItemRender();
    	}
    	if(par1World.getBlockMetadata(par2, par3, par4) == 2)
    	{
            this.setBlockBounds(0.9F, 0.0F, 0.0F, 0.9F, 1F, 1F);
            super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
            this.setBlockBounds(0F, 0.0F, 0.9F, 1F, 1F, 1.0F);
            super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
            this.setBlockBoundsForItemRender();
    	}
    	if(par1World.getBlockMetadata(par2, par3, par4) == 3)
    	{
        this.setBlockBounds(0F, 0.0F, 0.0F, 0.1F, 1F, 1F);
        super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
        this.setBlockBounds(0F, 0.0F, 0.9F, 1F, 1F, 1.0F);
        super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
        this.setBlockBoundsForItemRender();
