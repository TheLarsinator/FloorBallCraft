...
public class ItemBallG extends Item
{
    ...
    public String getItemStackDisplayName(ItemStack par1ItemStack)
    {
        ...
        String s1 = BallGSpawner.getStringFromID(par1ItemStack.getItemDamage());
    ...
    {
        if (!BallGSpawner.entityEggs.containsKey(Integer.valueOf(par1)))
        {
            return null;
        }
        else
        {
            ...
            for (int j = 0; j < 1; ++j)
            {
                entity = BallGSpawner.createEntityByID(par1, par0World);
    ...
    {
        Iterator iterator = BallGSpawner.entityEggs.values().iterator();

        while (iterator.hasNext())
        {
        	BallGSpawner.EntityBallInfo entityegginfo = (BallGSpawner.EntityBallInfo)iterator.next();
