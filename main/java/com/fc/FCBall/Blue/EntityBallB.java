...
public class EntityBallB extends EntityAnimal
{
    public EntityBallB(World par1World)
    {
        super(par1World);
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        {
        	this.setDead();
        	if (!par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ItemMain.BallB, 1, 122)))
            {
                par1EntityPlayer.dropItem(ItemMain.BallB, 122);
            }
        	return true;
        }
    }
     ...
     */
    public EntityBallB spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return null;
    }
