...
public class ItemBallB extends Item
{
    ...
    public String getItemStackDisplayName(ItemStack par1ItemStack)
    {
        ...
        String s1 = BallBSpawner.getStringFromID(par1ItemStack.getItemDamage());
    ...
    {
        if (!BallBSpawner.entityEggs.containsKey(Integer.valueOf(par1)))
        {
            return null;
        }
        else
        {
            ...
            for (int j = 0; j < 1; ++j)
            {
                entity = BallBSpawner.createEntityByID(par1, par0World);
    ...
    {
        Iterator iterator = BallBSpawner.entityEggs.values().iterator();

        while (iterator.hasNext())
        {
        	BallBSpawner.EntityBallInfo entityegginfo = (BallBSpawner.EntityBallInfo)iterator.next();
