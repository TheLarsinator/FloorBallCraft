...
public class ItemBallW extends Item
{
    ...
    public String getItemStackDisplayName(ItemStack par1ItemStack)
    {
        ...
        String s1 = BallWSpawner.getStringFromID(par1ItemStack.getItemDamage());
    ...
    {
        if (!BallWSpawner.entityEggs.containsKey(Integer.valueOf(par1)))
        {
            return null;
        }
        else
        {
            ...
            for (int j = 0; j < 1; ++j)
            {
                entity = BallWSpawner.createEntityByID(par1, par0World);
    ...
    {
        Iterator iterator = BallWSpawner.entityEggs.values().iterator();

        while (iterator.hasNext())
        {
        	BallWSpawner.EntityBallInfo entityegginfo = (BallWSpawner.EntityBallInfo)iterator.next();
