...
public class ItemBallR extends Item
{
    ...
    public String getItemStackDisplayName(ItemStack par1ItemStack)
    {
        ...
        String s1 = BallRSpawner.getStringFromID(par1ItemStack.getItemDamage());
    ...
    {
        if (!BallRSpawner.entityEggs.containsKey(Integer.valueOf(par1)))
        {
            return null;
        }
        else
        {
            ...
            for (int j = 0; j < 1; ++j)
            {
                entity = BallRSpawner.createEntityByID(par1, par0World);
    ...
    {
        Iterator iterator = BallRSpawner.entityEggs.values().iterator();

        while (iterator.hasNext())
        {
        	BallRSpawner.EntityBallInfo entityegginfo = (BallRSpawner.EntityBallInfo)iterator.next();
