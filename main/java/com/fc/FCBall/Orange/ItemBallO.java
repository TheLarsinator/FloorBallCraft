...
public class ItemBallO extends Item
{
    ...
    public String getItemStackDisplayName(ItemStack par1ItemStack)
    {
        ...
        String s1 = BallOSpawner.getStringFromID(par1ItemStack.getItemDamage());
    ...
    {
        if (!BallOSpawner.entityEggs.containsKey(Integer.valueOf(par1)))
        {
            return null;
        }
        else
        {
            ...
            for (int j = 0; j < 1; ++j)
            {
                entity = BallOSpawner.createEntityByID(par1, par0World);
    ...
    {
        Iterator iterator = BallOSpawner.entityEggs.values().iterator();

        while (iterator.hasNext())
        {
        	BallOSpawner.EntityBallInfo entityegginfo = (BallOSpawner.EntityBallInfo)iterator.next();
